...
def about_me():
    tmsg.showinfo('About Me','My self Smita Bose. Need Your Support Geeks(Like and Share the Vedio)')

def send_feedback():
    ans = tmsg.askquestion('Feedback', 'Was your experience good with us?')
    if ans == 'yes':
        tmsg.showinfo('Feedback','Please Like my vedio and share your experience in the Comment')
    else:
...
b2=Button(f,text='exp',font='lucida 15 bold', padx=20, pady=20, borderwidth=3, fg='black', bg='pink', width=3)
